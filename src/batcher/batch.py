...
class Batch(object):
    ...
    def __init__(self, component):
        ...
        desiredState = component.data.get('desiredState', {})
        self.clone_url = desiredState.get('cloneUrl', '')
        self.playbook = desiredState.get('playbook', '')
        self.commit = desiredState.get('commit', '')
    ...
    def _rebuild_from_session(cls, session):
        ...
        repo_data = session['repo']
        batch.clone_url = repo_data.get('cloneUrl')
        batch.commit = repo_data.get('commit')
        ansible_data = session['ansible']
        batch.playbook = ansible_data.get('playbook')
